 ...
 */
// Geometry
const waterGeometry = new THREE.PlaneGeometry(2, 2, 500, 128)
...
gui.add(waterMaterial.uniforms.uSmallWavesFrequency, 'value').min(0.8).max(30).step(0.001).name('uSmallWavesFrequency')
